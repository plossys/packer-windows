...
rem msiexec /qb /i C:\Windows\Temp\7z1604.msi

pushd C:\Windows\Temp
powershell -Command "(New-Object System.Net.WebClient).DownloadFile('http://mirrors.kernel.org/sourceware/cygwin/x86/release/rsync/rsync-3.1.2-1.tar.xz', 'C:\Windows\Temp\rsync-3.1.2-1.tar.xz')" <NUL
...
msiexec /qb /x C:\Windows\Temp\7z1604.msi
